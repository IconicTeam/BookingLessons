...
function Waiting (props) {
  ...
  function search(val){
    ...
    let newItems = newData.filter(({studentName})=> studentName.includes(val) )
  ...
  const DropdownComponent = () => {
    ...
    return (
      ...
      <View style={dropdownStyles.container}>
        {renderLabel1()}
        <Dropdown
          style={[dropdownStyles.dropdowns,{marginRight:RFValue(5)} ,isFocus1 && {borderColor: 'blue'}]}
      ...
      <View style={dropdownStyles.container}>
        {renderLabel2()}
        <Dropdown
          style={[dropdownStyles.dropdowns, isFocus2 && {borderColor: 'blue'}]}
          placeholderStyle={dropdownStyles.placeholderStyle}
          selectedTextStyle={dropdownStyles.selectedTextStyle}
          inputSearchStyle={dropdownStyles.inputSearchStyle}
          iconStyle={dropdownStyles.iconStyle}
    ...
    return(
      <View style={styles.studentDataStyle}>
          <View style={styles.imageNameStyel}>
            <Image style={styles.studentImage} source={require("../../../assets/icons/user.png")} />
            ...
            <TouchableOpacity style={[styles.iconViewStyel,{backgroundColor:"green"}]}>
              <Icon name='check' style={styles.acceptRejectIcon}/>
            </TouchableOpacity>
            <TouchableOpacity onPress={()=>{deleteItem(index)}} style={[styles.iconViewStyel,{backgroundColor:"red",marginLeft:RFValue(10)}]}>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.innerContainer}>
          <View style={styles.textInputView}>
            <MainTextInput placeholder={"البحث"} 
            onChangeText={(val)=>{
              search(val);
        ...
        <View style={styles.allStudentTitle}>
          ...
          <View style={styles.iconWrapper}>
            ...
            <TouchableOpacity style={[
              ...
              <Icon onPress={()=>{
                setStudents([])
              }} name='close' style={styles.acceptRejectIcon} 
            />
            </TouchableOpacity>
          </View>
        </View>
        <FlatList 
          ...
          data={students} renderItem={handlerRenderItem} 
